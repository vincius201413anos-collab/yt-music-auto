...
export const MyComposition = () => {
  ...
  return (
    <AbsoluteFill
      style={{
        background: "radial-gradient(circle at center, #24002f 0%, #070010 45%, #000 100%)",
        overflow: "hidden",
        justifyContent: "center",
        alignItems: "center",
        display: "flex",
        transform: `translate(${Math.sin(frame) * shake}px, ${Math.cos(frame * 1.3) * shake}px)`,
      }}
    >
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: "radial-gradient(circle, rgba(255,0,255,0.65), rgba(0,255,255,0.22), transparent 62%)",
      ...
      {[0, 1, 2].map((i) => (
        <div
          ...
          style={{
            ...
            transform: `translateX(${((frame * (3 + i) + i * 500) % 2600) - 1300}px) rotate(${20 + i * 18}deg)`,
            filter: "blur(25px)",
            opacity: 0.5,
          }}
        />
        ...
        return (
          <div
            ...
            style={{
              ...
              boxShadow: `0 0 ${glow}px ${color}, inset 0 0 ${glow * 0.45}px ${color}`,
              transform: `rotate(${frame * (0.6 + i * 0.35)}deg) scale(${1 + beat * 0.025 + drop * 0.08})`,
              opacity: 0.75 - i * 0.12,
            }}
          />
        );
        ...
        return (
          <div
            ...
            style={{
              ...
              boxShadow: `0 0 ${40 + drop * 50}px ${i % 2 ? "#00ffff" : "#ff00ff"}`,
            }}
          />
        );
      })}
      ...
      {[...Array(95)].map((_, i) => {
        ...
        const color = i % 3 === 0 ? "#ff00ff" : i % 3 === 1 ? "#00ffff" : "#9b5cff";
        return (
          <div
            key={`p-${i}`}
            style={{
      ...
      {[...Array(32)].map((_, i) => {
        const h = 35 + audioValue * (180 + drop * 220) + Math.abs(Math.sin(frame * 0.18 + i * 0.7)) * 80;
        return (
          <div
            key={`bar-l-${i}`}
            style={{
      ...
      {[...Array(32)].map((_, i) => {
        const h = 35 + audioValue * (180 + drop * 220) + Math.abs(Math.sin(frame * 0.2 + i * 0.9)) * 80;
        return (
          <div
            key={`bar-r-${i}`}
            style={{
      ...
      <img
        ...
        style={{
          ...
          filter: `drop-shadow(0 0 ${glow}px #00ffff) drop-shadow(0 0 ${glow * 1.7}px #ff00ff) brightness(${1.15 + beat * 0.35 + drop * 0.3}) contrast(1.16)`,
        }}
      />
    </AbsoluteFill>
  );
