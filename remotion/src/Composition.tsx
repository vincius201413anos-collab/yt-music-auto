...
export const MyComposition = () => {
  ...
  const audioIndex = Math.floor(frame / 2);
  ...
  return (
    <AbsoluteFill
      style={{
        background:
          "radial-gradient(circle at center, #24002f 0%, #070010 45%, #000 100%)",
        overflow: "hidden",
    ...
    >
      ...
      <img
        ...
        style={{
          ...
          filter: `
            drop-shadow(0 0 ${glow}px #00ffff)
            drop-shadow(0 0 ${glow * 1.7}px #ff00ff)
            brightness(${1.15 + beat * 0.35 + drop * 0.3})
            contrast(1.16)
          `,
        }}
      />
