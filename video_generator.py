...
INTRO_HOLD_SECONDS = 0.8  # 🔥 menor pra já prender atenção rápido
...
```
duration = random.randint(MIN_SHORT_DURATION, min(MAX_SHORT_DURATION, int(audio_duration)))
